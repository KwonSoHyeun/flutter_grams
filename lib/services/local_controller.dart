...
class LocalController {
  ...
  addTestData() {
    ...
    List<Cookery> list = [
      Cookery(title: '김치찌개1', kind:'', img:'', desc: '1. 익은김치를 잘게썬다 2. 물과함께 끓인후 돼지고기를 넣는다. 3.새우젓으로 간를 맞춘다,', caution: '익은 김치릉 사용할것', heart:false, hit:0, ingredients: [
      ...
      Cookery(
          ...
          caution: '미온수에 당면을 불리면 1시간 걸림', hit:2,
          heart:false, ingredients: [
